      ...
      <div class="detail-container">
        ...
        <div class="content">
          ...
          <div class="user-details">
            <p>User Id: <strong>{userDetails.userId}</strong></p>
            <p>
              Full Name:
            ...
            <p>Created on: <strong>{formatData(userDetails.createdAt)}</strong></p>
            <p>Modified on: <strong>{formatData(userDetails.updatedAt)}</strong></p>
          </div>
        </div>
      </div>
    </div>
